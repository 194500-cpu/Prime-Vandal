...
6) Connect Stock 1 (https://github.com/194500-cpu/Prime-Vandal/blob/main/STL-Files/stock1.stl) to Stock 2 (https://github.com/194500-cpu/Prime-Vandal/blob/main/STL-Files/stock2.stl) using the stock dowel (https://github.com/194500-cpu/Prime-Vandal/blob/main/STL-Files/stockdowel.stl). You will need to print 5 stock dowels.
7) Connect the stock to the stock extender (https://github.com/194500-cpu/Prime-Vandal/blob/main/STL-Files/stockextender.stl) by simply press fitting and gluing the two pieces together. 
8) Connect Top 1 (https://github.com/194500-cpu/Prime-Vandal/blob/main/STL-Files/top1.stl) to Top 2 (https://github.com/194500-cpu/Prime-Vandal/blob/main/STL-Files/top2.stl) using the top dowel (https://github.com/194500-cpu/Prime-Vandal/blob/main/STL-Files/topdowel.stl). You will need 2 top dowels.
9) Paint the parts if you wish!
10) Screw in the muzzle by simply using the retaliator's attachment point. Look at the hair dryer method in the hints section above if it is too tight! YOU DO NOT NEED GLUE
11) Push the stock into the retaliator stock attachment point by press fitting it. YOU DO NOT NEED GLUE
12) Glue the top onto the top of the Retaliator.
13) ENJOY YOUR PRIME VANDAL!
